...
const Footer = () => {
  return (
    <div className='bg-green text-sand-100 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4'>
      <div className='p-7 pl-10 pt-10'>
        <h1 className='font-title text-5xl p-5 text-peach-100'>Green Beauty</h1>
